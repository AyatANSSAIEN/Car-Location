<div class="w-full text-white bg-black dark-mode:text-gray-200 dark-mode:bg-gray-800">
    <div x-data="{ open: false }"
        ...
        <nav :class="{'flex': open, 'hidden': !open}"
            ...
            <a class="px-4 py-2 mt-2 text-md font-semibold bg-transparent rounded-lg md:mt-0 md:ml-4 focus:text-gray-900 hover:bg-red-500 focus:outline-none focus:shadow-outline transition delay-100 duration-300 ease-in-out "
                href="/">Home</a>
            <a class="px-4 py-2 mt-2 text-md font-semibold bg-transparent rounded-lg md:mt-0 md:ml-4 focus:text-gray-900 hover:bg-red-500 focus:outline-none focus:shadow-outline transition delay-100 duration-300 ease-in-out "
                href="/articles">Artciles</a>
            @can('manage-demande')
                <a class="px-4 py-2 mt-2 text-md font-semibold bg-transparent rounded-lg md:mt-0 md:ml-4 focus:text-gray-900 hover:bg-red-500 focus:outline-none focus:shadow-outline transition delay-100 duration-300 ease-in-out "
                    href="/partner#articles">Partner</a>
                <a class="px-4 py-2 mt-2 text-md font-semibold bg-transparent rounded-lg md:mt-0 md:ml-4 focus:text-gray-900 hover:bg-red-500 focus:outline-none focus:shadow-outline transition delay-100 duration-300 ease-in-out "
                    href="/partner#demandes">Demandes</a>
            @endcan
        </nav>
