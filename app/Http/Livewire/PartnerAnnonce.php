...
class PartnerAnnonce extends Component
{
    ...
    public function edit($formData, $id)
    {
        ...
        Annonce::where('id', '=', $id)->update(['title' => $formData['title'], 'description' => $formData['desc'], 'car_model' => $formData['carModel'], 'city' => $formData['city'], 'color' => $formData['color'], 'price' => $formData['price'],
